...
const validBom = {
  ...
  standard_loss_pct: 5,
  bom_yarn_items: [
    { yarn_catalog_id: 'yarn-1', ratio_pct: 60, consumption_kg_per_m: 0.3 },
    { yarn_catalog_id: 'yarn-2', ratio_pct: 40, consumption_kg_per_m: 0.2 },
  ]
};
...
const invalidRatioBom = {
  ...
  bom_yarn_items: [
    { yarn_catalog_id: 'yarn-1', ratio_pct: 60, consumption_kg_per_m: 0.3 },
    { yarn_catalog_id: 'yarn-2', ratio_pct: 30, consumption_kg_per_m: 0.2 },
  ]
};
