...
const path = 'src/features/purchase-orders/PODetailPage.tsx';
...
const old_info_chunk = `<div className="space-y-3">
...
const new_info_chunk = `<div className="grid grid-cols-2 gap-y-4 gap-x-6">
...
// 5. Update "Thao tác"
const old_actions_chunk = `          <div className="flex flex-wrap gap-3">
            {po.status === 'draft' &&
...
const new_actions_chunk = `          <div className="flex flex-col gap-3">
...
const old_cells_chunk = `                    <td className="p-3 font-medium">{item.material_id}</td>
...
const new_cells_chunk = `                    <td className="px-4 py-3 font-medium text-gray-800">{item.material_id}</td>
...
const old_gr_empty_chunk = `        {receipts.length === 0 ? (
          <div className="p-8 text-center text-muted">
            Chưa có phiếu nhập kho nào.
          </div>
        ) : (`

const new_gr_empty_chunk = `        {receipts.length === 0 ? (
