...
export const rawFabricDefaults: RawFabricFormValues = {
  roll_number: '', fabric_type: '', color_name: 'Mộc (Raw)', color_code: '',
  width_cm: undefined, length_m: undefined, weight_kg: undefined,
  quality_grade: undefined, status: 'in_stock', warehouse_location: '',
  production_date: '', notes: '', yarn_receipt_id: '', work_order_id: '',
  weaving_partner_id: '', lot_number: '',
}
...
export function findDuplicateRollNumbers(rolls: Array<Pick<BulkRollRow, 'roll_number'>>): string[] {
...
export const bulkInputDefaults: BulkInputFormValues = {
  fabric_type: '', color_name: 'Mộc (Raw)', color_code: '', width_cm: undefined,
  quality_grade: undefined, status: 'in_stock', warehouse_location: '',
  production_date: '', weaving_partner_id: '', yarn_receipt_id: '',
  work_order_id: '', lot_number: '', roll_prefix: 'RM-', start_number: 1,
  rolls: [{ roll_number: formatBulkRollNumber('RM-', 1), weight_kg: undefined as unknown as number, length_m: undefined, quality_grade: undefined, notes: '' }],
}
