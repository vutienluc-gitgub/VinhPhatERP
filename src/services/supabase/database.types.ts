...
export type Database = {
  ...
  public: {
    Tables: {
      background_jobs: {
        Row: {
          ...
          target_entity_table: string | null;
      ...
      contract_audit_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'contract_audit_logs_performed_by_fkey';
      ...
      contract_order_links: {
        ...
        Relationships: [
          {
            foreignKeyName: 'contract_order_links_contract_id_fkey';
            columns: ['contract_id'];
            isOneToOne: false;
            referencedRelation: 'contracts';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'contract_order_links_linked_by_fkey';
            columns: ['linked_by'];
            isOneToOne: false;
            referencedRelation: 'profiles';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'contract_order_links_order_id_fkey';
            columns: ['order_id'];
            isOneToOne: false;
      ...
      contracts: {
        Row: {
          ...
          party_b_bank_account: string | null;
          party_b_name: string;
          party_b_representative: string | null;
          party_b_tax_code: string | null;
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'contracts_source_order_id_fkey';
      ...
      finished_fabric_rolls: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'finished_fabric_rolls_supplier_id_fkey';
            columns: ['supplier_id'];
            isOneToOne: false;
            referencedRelation: 'suppliers';
            referencedColumns: ['id'];
      ...
      goods_receipt_items: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ['po_item_id'];
            isOneToOne: false;
            referencedRelation: 'v_po_item_status';
            referencedColumns: ['id'];
          },
          {
      ...
      goods_receipts: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ['po_id'];
            isOneToOne: false;
            referencedRelation: 'v_po_detail_full';
            referencedColumns: ['id'];
          },
        ];
      };
      ...
      looms: {
        ...
        Relationships: [
          {
            foreignKeyName: 'looms_supplier_id_fkey';
            columns: ['supplier_id'];
            isOneToOne: false;
            referencedRelation: 'suppliers';
            referencedColumns: ['id'];
      ...
      order_lot_allocations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'order_lot_allocations_tenant_id_fkey';
            columns: ['tenant_id'];
            isOneToOne: false;
            referencedRelation: 'tenants';
            referencedColumns: ['id'];
      ...
      progress_audit_log: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'progress_audit_log_tenant_id_fkey';
            columns: ['tenant_id'];
            isOneToOne: false;
            referencedRelation: 'tenants';
            referencedColumns: ['id'];
      ...
      raw_fabric_rolls: {
        ...
        Relationships: [
          {
            foreignKeyName: 'raw_fabric_rolls_loom_id_fkey';
            columns: ['loom_id'];
            isOneToOne: false;
      ...
      work_orders: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'work_orders_loom_id_fkey';
            columns: ['loom_id'];
            isOneToOne: false;
            referencedRelation: 'looms';
            referencedColumns: ['id'];
      ...
      yarn_reservations: {
        ...
        Relationships: [
          {
            foreignKeyName: 'yarn_reservations_tenant_id_fkey';
            columns: ['tenant_id'];
            isOneToOne: false;
            referencedRelation: 'tenants';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'yarn_reservations_work_order_id_fkey';
            columns: ['work_order_id'];
            isOneToOne: false;
            referencedRelation: 'work_orders';
            referencedColumns: ['id'];
    ...
    Functions: {
      ...
      next_po_code: { Args: never; Returns: string };
      ...
      rpc_increment_dyeing_order_paid: {
      ...
      rpc_release_yarn_reservation: {
        Args: { p_work_order_id: string };
        Returns: undefined;
      };
      rpc_reserve_finished_roll: {
        Args: { p_order_id: string; p_roll_id: string };
        Returns: undefined;
      };
      rpc_reserve_yarn: {
        Args: { p_items: Json; p_work_order_id: string };
        Returns: Json;
      };
      rpc_resolve_job: {
        Args: { p_error?: string; p_job_id: number; p_status: string };
        Returns: undefined;
      };
      rpc_revise_bom: {
      ...
      rpc_upsert_role_permissions: {
        Args: { p_permissions: Json; p_role: string; p_tenant_id: string };
        Returns: undefined;
      };
