...
export const DASHBOARD_LABELS = {
  ...
  BTN_NEW_ORDER: 'Tạo đơn mới',
  BTN_NEW_ORDER_SHORT: 'Thêm',
  LIVE_UPDATE: 'Đang cập nhật',
  KPI_PROCESSING: 'Đang xử lý',
  KPI_OVERDUE: 'Trễ hạn',
  KPI_OVERDUE_ACTION: 'Cần xử lý ngay',
  KPI_ON_TIME: 'Đúng tiến độ',
  KPI_TOTAL_DEBT: 'Tổng công nợ',
  KPI_RECENT_PAYMENT: 'Thu 7 ngày qua',
  KPI_DRAFT: 'Đơn nháp',
  KPI_PENDING_SHIP: 'Chờ giao',
  KPI_CONVERSION: 'Tỷ lệ chốt',
  KPI_EXPIRING_QUOTE: 'BG sắp hết hạn',
} as const;
...
> = {
  success: {
    label: 'Hoàn thành',
    cssClass: 'text-success bg-success-soft/10',
  },
