...
export function FabricImageGalleryCard({
  ...
  return (
    <div
      key={id}
      className="bg-surface rounded-xl border border-default overflow-hidden shadow-sm hover:shadow-md transition-shadow group flex flex-col sm:flex-row items-stretch"
    >
      <div className="w-full sm:w-48 aspect-[4/3] sm:aspect-square bg-surface-secondary relative group shrink-0 border-b sm:border-b-0 sm:border-r border-default">
        ...
        <button
          ...
          className="absolute top-2 right-2 bg-surface/90 hover:bg-red-50 text-muted-foreground hover:text-danger p-1.5 rounded-lg shadow-sm opacity-0 group-hover:opacity-100 transition-all"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3">
          <div className="grid grid-cols-[1fr_60px] gap-2">
            ...
            <Controller
              ...
              render={({ field }) => (
                <NumericInput
                  className="w-full border-default bg-surface text-foreground rounded-lg text-xs py-1.5 px-2 focus:ring-1 focus:ring-primary/20 transition-all"
                  value={field.value}
          ...
          <div>
            ...
            <input
              ...
              className="w-full border-default bg-surface text-foreground rounded-lg text-xs py-1.5 px-3 focus:ring-1 focus:ring-primary/20 transition-all"
          ...
          <div className="flex items-center">
            <label className="flex items-center gap-2 cursor-pointer bg-surface border border-default px-3 py-1.5 rounded-lg hover:border-primary/50 transition-colors w-full sm:w-auto">
              <input
                type="checkbox"
                className="rounded border-muted text-foreground focus:ring-primary w-4 h-4"
