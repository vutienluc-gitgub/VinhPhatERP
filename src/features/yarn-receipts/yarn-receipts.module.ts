...
export type { DocStatus, YarnReceiptItemFormValues, YarnReceiptsFormValues } from '@/schema/yarn-receipt.schema'
...
export const yarnReceiptsFeature: FeatureDefinition = {
  ...
  title: 'Nhập sợi',
  badge: 'Active',
  description: 'Module đầu chuỗi nghiệp vụ — ghi nhận phiếu nhập sợi từ nhà cung cấp.',
  summary: [
