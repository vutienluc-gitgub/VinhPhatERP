...
export const SETTINGS_LABELS = {
  ...
  PRINT_MARGIN_TITLE: 'Lề trang (Tránh dải lỗ kéo giấy)',
  PRINT_MARGIN_TOP: 'Lề trên',
  PRINT_MARGIN_BOTTOM: 'Lề dưới',
  PRINT_MARGIN_LEFT: 'Lề trái (Tránh dải lỗ kéo giấy)',
  PRINT_MARGIN_RIGHT: 'Lề phải (Tránh dải lỗ kéo giấy)',
  ...
  PRINT_A5_SPEC_TITLE: 'Thông số giấy & Lề in kim (A5)',
  ...
  PRINT_PRESET_A5_VP: 'A5 Vĩnh Phát (200×148mm)',
  PRINT_PRESET_A5_ISO: 'A5 ISO (210×148mm)',
  PRINT_PRESET_A5_NARROW: 'A5 Khổ hẹp (190×140mm)',
  ...
  PRINT_FOOTER_NOTE_PLACEHOLDER:
    'VD: Vui lòng kiểm tra kỹ số lượng và chất lượng trước khi rời kho.',
  PRINT_ZOOM_TITLE: 'Tỷ lệ xem',
  PRINT_FIXTURE_LABEL: 'Dữ liệu mẫu',
  PRINT_FIXTURE_SHORT: 'Đơn ngắn (3 dòng)',
  PRINT_FIXTURE_LONG: 'Đơn dài (10 cuộn)',
...
export const SETTINGS_PLACEHOLDERS = {
  ...
  NOTIFICATION_EMAIL: 'VD: 1081991@gmail.com',
