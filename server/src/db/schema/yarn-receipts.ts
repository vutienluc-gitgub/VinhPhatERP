...
export const yarnReceipts = pgTable(
  'yarn_receipts',
  {
...
export const yarnReceiptItems = pgTable(
  'yarn_receipt_items',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    receiptId: uuid('receipt_id')
      .notNull()
      .references(() => yarnReceipts.id, { onDelete: 'cascade' }),
    ...
    yarnCatalogId: uuid('yarn_catalog_id').references(() => yarnCatalogs.id, {
      onDelete: 'set null',
    }),
  },
  (t) => [
