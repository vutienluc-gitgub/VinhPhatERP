-- Fix RPC function to include tenant_id (resolves RLS error)

CREATE OR REPLACE FUNCTION rpc_create_work_order(
  p_wo_data JSONB,
  p_reqs_data JSONB,
...
BEGIN
  INSERT INTO work_orders (
    tenant_id, work_order_number, order_id, bom_template_id, bom_version, target_quantity_m,
