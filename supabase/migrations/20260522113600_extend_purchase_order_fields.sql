...
ALTER TABLE purchase_orders
  ADD COLUMN IF NOT EXISTS person_in_charge VARCHAR(255),
  ...
  ADD COLUMN IF NOT EXISTS shipping_fee DECIMAL(19,4) DEFAULT 0,
  ADD COLUMN IF NOT EXISTS delivery_warehouse VARCHAR(255),
  ADD COLUMN IF NOT EXISTS subtotal_amount DECIMAL(19,4) DEFAULT 0,
