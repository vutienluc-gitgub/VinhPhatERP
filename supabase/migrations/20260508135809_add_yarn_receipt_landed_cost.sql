-- Add cost allocation fields to yarn_receipt_items
ALTER TABLE yarn_receipt_items
ADD COLUMN allocated_cost numeric(18,2) NOT NULL DEFAULT 0 CHECK (allocated_cost >= 0),
ADD COLUMN landed_price numeric(18,2) NOT NULL DEFAULT 0 CHECK (landed_price >= 0);

-- Update Create RPC with Landed Cost allocation
...
-- Update Update RPC with Landed Cost allocation
