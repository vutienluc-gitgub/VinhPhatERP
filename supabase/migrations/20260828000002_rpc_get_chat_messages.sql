-- ============================================================
-- Migration: Atomic single RPC for chat messages with reactions
-- Description: Merges chat_messages and chat_message_reactions into a single
-- query with aggregated reactions and sender details, eliminating N+1 DB calls.
-- ============================================================
