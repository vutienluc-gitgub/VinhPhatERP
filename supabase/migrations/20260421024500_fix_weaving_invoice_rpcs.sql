-- Drop the duplicate functions created by mistake
DROP FUNCTION IF EXISTS atomic_create_weaving_invoice(JSONB, JSONB);
DROP FUNCTION IF EXISTS atomic_update_weaving_invoice(UUID, JSONB, JSONB);
